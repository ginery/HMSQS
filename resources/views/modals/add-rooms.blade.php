        ...
        <div>
            <form id="addForm" class="p-5 grid grid-cols-12 gap-4 row-gap-3" enctype="multipart/form-data">
                <div class="col-span-12 sm:col-span-12">
                    ...
                    <input type="text" name="room_name" class="input w-full border mt-2 flex-1" placeholder="Room Name" required>
                </div>
                <div class="col-span-12 sm:col-span-12">
                    <label>Room Type</label>
                    <select name="room_type" class="select2 w-full border mt-2 flex-1" required>
                ...
                <div class="col-span-12 sm:col-span-12">
                    ...
                    <select name="child" class="select2 w-full border mt-2 flex-1" required>
                        <option value="0" selected>0</option>
                        <option value="1">1</option>
                        <option value="2">2</option>
                        <option value="3">3</option>
                ...
                <div class="col-span-12 sm:col-span-12">
                    ...
                    <input type="text" name="description" class="input w-full border mt-2 flex-1" placeholder="Description" required>
                </div>
                <div class="col-span-12 sm:col-span-12">
                    <label>Image</label>
